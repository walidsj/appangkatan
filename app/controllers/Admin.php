	...
	public function semester()
	{
		...
		if ($action == 'delete') {
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/deleteSemesterPage', $data);
			} else {
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/addSemesterPage', $data);
			} else {
				$semesterData = [
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/editSemesterPage', $data);
			} else {
				$semesterData = [
					'namaSemester' => $this->input->post('nama', true),
	...
	public function matkul()
	{
		...
		if ($action == 'delete') {
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/deleteMatkulPage', $data);
			} else {
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/addMatkulPage', $data);
			} else {
				$matkulData = [
			...
			if ($validate->run() == false) {
				...
				$this->load->view('pages/admin/editMatkulPage', $data);
			} else {
				$matkulData = [
					'namaMatkul' => $this->input->post('nama', true),
					'semesterMatkul' => $this->input->post('semester', true),
