                     ...
                     <div class="col-lg-6 mb-4">
                        <div class="card shadow mb-4">
                           ...
                           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                              <h6 class="m-0 font-weight-bold text-primary">Yakin Hapus Admin ini?</h6>
                           </div>
                           <!-- Card Body -->
                           <div class="card-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control" value="<?= $userItem->namaUser; ?>" disabled>
                              </div>
                              <div class="form-group">
                                 <label>NPM Mahasiswa</label>
                                 <input class="form-control" value="<?= $userItem->npmUser; ?>" disabled>
                              </div>
                              <div class="form-group">
                                 <label>Program Studi</label>
                                 <input class="form-control" value="<?= $userItem->namaProdi; ?>" disabled>
                              </div>
                              <div class=" form-group">
                                 <div class="custom-control custom-checkbox small">
                                    <input name="check" type="checkbox" class="custom-control-input" id="check">
                                    <label class="custom-control-label" for="check">Saya yakin ingin menghapus admin ini.</label>
                                 </div>
                                 <?= form_error('check'); ?>
                              </div>
